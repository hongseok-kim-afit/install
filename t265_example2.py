...
cfg = rs.config()
cfg.enable_device('119622110606') # T265 camera serial No. 119622110606

# Start streaming with our callback
pipe2.start(cfg, callback)
...
'''
result
Left camera: [ 848x800  p[421.691 398.019]  f[285.14 285.238]  Kannala Brandt4 [-0.00345935 0.0386507 -0.0364724 0.00585985 0] ]
Right camera: [ 848x800  p[426.008 397.556]  f[285.416 285.481]  Kannala Brandt4 [-0.00521194 0.042136 -0.0395501 0.00676212 0] ]
