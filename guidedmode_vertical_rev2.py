...
desired_distance = 3 #distance from desired target in meters
...
pipe = rs.pipeline()
config = rs.config()
config.enable_device('035722250134')
    ...
    if mode == 'GUIDED':
      ...
      if len(corners) > 0:
        ...
        for (markerCorner, markerID) in zip(corners, ids):
            ...
            cv2.circle(aruco_res, (1280,800), 4, (0, 0, 255), -1)        
        ...
        yaw_depth1 = depth[frame_center[0]-50, frame_center[1]]
        yaw_depth2 = depth[frame_center[0]+50, frame_center[1]]
        ...
        if target_orientation =='vertical':
                print(yaw_rate,':commanded yaw rate')
