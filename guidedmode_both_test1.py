...
try:
    ...
    while True:
        ...
        for contour in c:
            ...
            cv2.rectangle(d435_res, (x, y), (x + w, y + h), (0, 255, 0), 3)
            text = "Depth: " + str("{0:.2f}").format(dist)
            cv2.putText(d435_res,
                        text,
        ...
        if valid:
            ...
            #     # Fetch pose frame
            #     pose2 = frames2.get_pose_frame()
            #     if pose2:
            #         # Print some of the pose data to the terminal
            #         data = pose2.get_pose_data()
            #         print("Frame #{}".format(pose2.frame_number))
            ...
            if mode_t265 == "stack":
                ...
                cv2.imshow(WINDOW_TITLE1, d435_res)
